...
/* package edMonad-0.1.0.0 */
#ifndef VERSION_edMonad
#define VERSION_edMonad "0.1.0.0"
#endif /* VERSION_edMonad */
#ifndef MIN_VERSION_edMonad
#define MIN_VERSION_edMonad(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_edMonad */
...
#define CURRENT_COMPONENT_ID "edMonad-0.1.0.0-inplace-edMonad"
